...
module.exports = {
  ...
  onStart: async function ({ api, event, message }) {
    try {
      ...
      const loadingMessage = await api.sendMessage("𝗹𝗼𝗮𝗱𝗶𝗻𝗴 𝗮 𝗿𝗮𝗻𝗱𝗼𝗺 𝗺𝘂𝘀𝗶𝗰 𝗼𝗳 𝗲𝗱𝗴𝗲 𝗯𝗮𝗻𝗱 𝗽𝗹𝗲𝗮𝘀𝗲 𝘄𝗮𝗶𝘁... 🎵", event.threadID, null, event.messageID);

      const apiKey = "AIzaSyAO1tuGus4-S8RJID51f8WJAM7LXz1tVNc";
      const playlistId = "PLCiXFxWx8d2Bf6Z5BQ3RBFmHsRB3dVr0X";
